...
import edu.computerpower.student.weatherapp.openweatherobjects.List;
import edu.computerpower.student.weatherapp.openweatherobjects.Weather;
import edu.computerpower.student.weatherapp.utility.ConvertTime;
...
public class GetWeatherActivity extends ActionBarActivity {
	...
	public void convertJsonString(String result) {
		...
		edu.computerpower.student.weatherapp.openweatherobjects.RootObject ro = gson.fromJson(result, edu.computerpower.student.weatherapp.openweatherobjects.RootObject.class);
